...
The consultant will lead a five-month study to assess existing infrastructure, institutional capacity, and available technology within Flanders, and evaluate how the global systems part of the Intergovernmental Oceanographic Commission—such as OBIS, the Ocean Data Information System (ODIS), and the OceanTeacher Global Academy (OTGA)—can be leveraged to support the development of the future UNESCO Biosphere Observatories for Ocean Ecosystem Sustainability (BiOES) project. The work will involve desk research, stakeholder interviews, site visits, coordination with UNESCO partners, and the preparation of a comprehensive final report including recommendations.
