---
layout: post
title: "OBIS Poland: from the Baltic Sea to the North Atlantic, a trove of data and a reservoir of expertise"
lang: en
author: OBIS
tags:
- OBIS Poland
...
imageAlt: "The Research Vessel s/y OCEANIA arriving at the Svalbard Archipelago on 3 August 2018 to conduct fieldwork for the Svalbard Intertidal Project (SIP), a research programme from IO PAN focused on the intertidal ecosystems of Svalbard. Photo: IO PAN"
imageCaption: "The Research Vessel s/y OCEANIA arriving at the Svalbard Archipelago on 3 August 2018 to conduct fieldwork for the Svalbard Intertidal Project (SIP), a research programme from IO PAN focused on the intertidal ecosystems of Svalbard.<br>Photo: IO PAN"
---
Poland joins OBIS! With [nine datasets](https://obis.org/node/dfef65ad-91ce-4fcb-ae2a-8145f9cbcf0b) (and counting!) already published on the platform, the OBIS Poland Node is off to a quick start. We sat down with **Marcin Wichorowski**, OBIS Poland Node Manager; **Monika Grabowska**, OBIS Poland Data Manager; **Monika Kędra**, IO PAN Deputy Director for Research; and **Jan Marcin Węsławski**, marine biodiversity researcher and former director of IO PAN, to discuss the context and challenges related to marine biodiversity data in Poland and explore what led to the creation of the node.
<br><br>

For the last 40 years, Poland has been a major actor in marine biodiversity data collection from the Baltic Sea, its natural basin, but also from the North Atlantic, through scientific expeditions taking place between Svalbard, Greenland, and northern Norway. Poland has been, and still is, well-connected to regional marine biodiversity data initiatives, such as EurOBIS, EMODnet and SeaDataNet. Yet, Poland has been facing a triple interlocked challenge preventing the country from contributing in full capacity to global biodiversity platforms, such as OBIS: a fragmented landscape of data providers, lack of national coordination under a centralized publication flow, and huge troves of unpublished historical data sitting at institutions.
...
In addition, OBIS, as a global data platform, would also serve as a centralized destination for Polish marine biodiversity datasets, in alignment with the national data strategy. For Jan Marcin Węsławski, OBIS perfectly fits the needs of the Polish marine biodiversity data community: *"My perspective is that OBIS was a very natural choice, because, to make it very simple, we would like to be in good company. I know the people who work with OBIS, with whom we have a long history of mutual contacts and networking, and I trust them."*
...
<br><br>
<img alt="Collection of various organisms from soft sediment and hard bottom by the SIP expedition team. Photo: IO PAN" src="/images/OBIS-Poland_00006.jpeg" style="width: 100%;">
...
<br><br>
<img alt="Photo of a Calanus hyperboreus (Goës, 1866) specimen, part of the DWARF Species gallery. DWARF is a research project investigating whether rising temperatures are causing Arctic animals to become smaller and what this could mean for ecosystems. Photo: Maria WK / DWARF project / IO PAN" src="/images/OBIS-Poland_00007.jpg" style="width: 100%;">
<p style="text-align: center;"><i>Photo of a Calanus hyperboreus (Goës, 1866) specimen, part of the DWARF Species gallery. DWARF is a research project investigating whether rising temperatures are causing Arctic animals to become smaller and what this could mean for ecosystems.<br>Photo: Maria WK / DWARF project / IO PAN</i></p>
<br><br>

The launch of the OBIS Poland Node marks the culmination of decades of data collection, institutional groundwork, and community-building around marine biodiversity in Poland. With a unified national workflow now in place and a growing catalogue of published datasets, the Node stands as a model for how sustained collaboration between institutions can turn locally-held historical records into globally accessible, FAIR data. ◼️
