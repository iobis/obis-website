...
purpose: news
feed: true
image: /images/edna_event_core_illu_01.svg
---
...
<br><br>
<img alt="Comparison between the Occurrence core and the Event core approach to managing extendedMeasurementOrFact data." src="/images/edna_event_core_illu_01.svg" style="width: 100%;">
...
<br><br>
<img alt="Flowchart showing the data pipeline from field collection through DNA-derived occurrences, sampling events, and environmental measurements, to Event Core formatting, OBIS integration, EOV alignment, and publication to OBIS." src="/images/edna_event_core_illu_02.svg" style="width: 100%;">
