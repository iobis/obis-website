...
<br><br>
<img alt="Comparison between the Occurrence core and the Event core approach to managing extendedMeasurementOrFact data." src="/images/2026.6-eDNA-Event-Core.md_illu_01.jpg" style="width: 100%;">
...
<br><br>
<img alt="Flowchart showing the data pipeline from field collection through DNA-derived occurrences, sampling events, and environmental measurements, to Event Core formatting, OBIS integration, EOV alignment, and publication to OBIS." src="/images/2026.6-eDNA-Event-Core.md_illu_02.jpg" style="width: 100%;">
