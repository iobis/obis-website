...
Emerging data types often pose challenges for repositories in terms of management, standardization, and integration. MedOBIS, the OBIS Node for the Mediterranean, proposed a solution for this challenge and published its first-ever Darwin Core-formatted dataset that included micro-Computed Tomography Morphological image-derived information, along with biodiversity and environmental data on two species, *Chondrilla nucula* and *Hexaplex trunculus* (https://doi.org/10.25607/vjxlve).
